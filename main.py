...
def run_kakao_realtime_rank():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # 헤더에 '플랫폼' 추가
            data_to_push = [["순위", "플랫폼", "타이틀", "작가", "장르", "조회수", "수집일"]]
            ...
            for i, link in enumerate(unique_links[:20]):
                try:
                    ...
                    # 데이터 행에 '카카오페이지' 추가
                    data_to_push.append([f"{i+1}위", "카카오페이지", title, author, genre, views, "2026-02-24"])
            ...
            print("🎊 플랫폼 정보까지 포함하여 업데이트를 완료했습니다!")
